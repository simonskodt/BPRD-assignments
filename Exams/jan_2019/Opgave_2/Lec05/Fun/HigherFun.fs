...
(* Exam *)
let ex01 = Let("x", Record [], Var "x")
let ex03 = Let("x", Record [("field1", CstI 32), ("field2", CstI 33)], Var "x" )
let ex04 = Let("x", Record [("field1", CstI 32), ("field2", CstI 33)], Field("x", "field1"))
let ex05 = Let("x", Record [("field1", CstI 32), ("field2", CstI 33)], Prim("+", Field("x", "field1"), Field("x", "field2")))