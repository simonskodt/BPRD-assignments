...
// Exam examples
let as21 = Parse.fromString @"let x = 23 in x within [2+3,40] end";;  // Expected 1
let as22 = Parse.fromString @"let x = 23 in x within [2-10,40] end";; // Expected 1
let as23 = Parse.fromString @"let x = 23 in x within [25,40] end";;   // Expected 0
