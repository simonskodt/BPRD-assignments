...
type value = 
  | Int of int
  | RecordV of (string * value) list (* Exam *)
...
// Eksempler med sammenfaldne navne
let exam6 = Let ("x", Record [("field1", CstI 32); ("field1", CstI 33)], (Prim ("+", Field (Var "x","field1"), Field (Var "x","field1"))));;
let exam7 = Let ("x", Record [("field1", CstI 32); ("field2", CstI 21); ("field1", CstI 33)], (Var "x"));;
let exam8 = Let ("x", Record [("f1", CstI 32); ("f2", CstI 21); ("f3", CstI 33); ("f1", CstI 33)], (Field (Var "x","f1")));;
